...
RHEIA requires Python 3.11 or newer. Python can be installed in several ways on your system. If the distribution platform is no constraint,
...
Alternatively, install the package from the source code. First, clone the repository::

	git clone https://github.com/rheia-framework/RHEIA.git

Then, from that directory, install the package and its dependencies::
